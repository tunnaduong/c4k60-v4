...
<html>
  ...
  <head>
      ...
      <title>Thư viện ảnh C4K60 - Ảnh thẻ</title>
...
?>
    ...
    <a class="breadcrumb-item" href="index.php">Trang chủ</a><a class="breadcrumb-item" href="Anhthe.php">Ảnh thẻ</a>
   <div id="tunna">
...
$sql = "SELECT * FROM thuvienanh WHERE album = 77";
