    ...
    <div id="root">
        ...
        @if (isset($_SESSION['user']))
            <div style="display: flex;flex-direction: row;gap: 10px;align-items:center;margin-bottom: 13px"
                href="/profile/{{ $_SESSION['user']->username }}">
        ...
        @else
            <div style="display: flex;flex-direction: row;gap: 10px;align-items:center;margin-bottom: 13px" href="/login">
                <img src="/assets/images/user.png" width="50" style="border-radius: 50%">
                <div>
                    <h3 class="cursor-pointer" style="font-size: 20px;font-weight: 500">Khách</h3>
                    <span style="font-size: 14px;color: gray">Đăng nhập để xem thông tin cá nhân</span>
                </div>
            </div>
        @endif
        <hr style="border-top: 1px solid gray">
        <div style="display:flex;flex-direction: row;align-items:center;padding: 10px 0;gap: 10px" href="/gallery">
        ...
        <div style="display:flex;flex-direction: row;align-items:center;padding: 10px 0;gap: 10px" href="/birthdays">
            <ion-icon name="gift-outline" style="font-size: 24px;color: #fd6664"></ion-icon>
            <span style="flex: 1">Sinh nhật sắp tới</span>
            <ion-icon name="chevron-forward-outline" style="font-size: 24px;color: #9e9f9f"></ion-icon>
        </div>
        <div style="display:flex;flex-direction: row;align-items:center;padding: 10px 0;gap: 10px" href="/profiles">
            <ion-icon name="people-outline" style="font-size: 24px;color: #009c00"></ion-icon>
            <span style="flex: 1">Hồ sơ thành viên</span>
            <ion-icon name="chevron-forward-outline" style="font-size: 24px;color: #9e9f9f"></ion-icon>
        </div>
        <div style="display:flex;flex-direction: row;align-items:center;padding: 10px 0;gap: 10px" href="/friends-near-me">
            <ion-icon name="location-outline" style="font-size: 24px;color: #de0092"></ion-icon>
            <span style="flex: 1">Bạn bè quanh đây</span>
            <ion-icon name="chevron-forward-outline" style="font-size: 24px;color: #9e9f9f"></ion-icon>
        </div>
        <div style="display:flex;flex-direction: row;align-items:center;padding: 10px 0;gap: 10px" href="/listen-together">
            <ion-icon name="musical-notes-outline" style="font-size: 24px;color: #00b7b4"></ion-icon>
            <span style="flex: 1">Nghe nhạc cùng nhau</span>
            <ion-icon name="chevron-forward-outline" style="font-size: 24px;color: #9e9f9f"></ion-icon>
        </div>
        <div style="display:flex;flex-direction: row;align-items:center;padding: 10px 0;gap: 10px" href="/calendar">
            <ion-icon name="calendar-outline" style="font-size: 24px;color: #9b0041"></ion-icon>
            <span style="flex: 1">Lịch & Sự kiện</span>
            <ion-icon name="chevron-forward-outline" style="font-size: 24px;color: #9e9f9f"></ion-icon>
        </div>
        <div style="display:flex;flex-direction: row;align-items:center;padding: 10px 0;gap: 10px" href="/feedback">
            <ion-icon name="chatbox-ellipses-outline" style="font-size: 24px;color: #216bfe"></ion-icon>
            <span style="flex: 1">Đóng góp ý kiến</span>
            <ion-icon name="chevron-forward-outline" style="font-size: 24px;color: #9e9f9f"></ion-icon>
        </div>
        <div style="display:flex;flex-direction: row;align-items:center;padding: 10px 0;gap: 10px" href="/report-a-problem">
            <ion-icon name="warning-outline" style="font-size: 24px;color: #bea500"></ion-icon>
            <span style="flex: 1">Báo cáo sự cố</span>
            <ion-icon name="chevron-forward-outline" style="font-size: 24px;color: #9e9f9f"></ion-icon>
        </div>
        <div style="display:flex;flex-direction: row;align-items:center;padding: 10px 0;gap: 10px" href="/settings">
